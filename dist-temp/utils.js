...
exports.fmt6 = exports.fmt8 = exports.fmt9 = exports.fmt12 = exports.fmt18 = exports.bn6 = exports.bn8 = exports.bn9 = exports.bn12 = exports.bn18 = exports.bn = exports.max = exports.ether = exports.zero = void 0;
 ...
 */
function bn18(n) {
    return bn(web3_1.default.utils.toWei(n.toString().split(",").join(""), "ether"));
}
exports.bn18 = bn18;
/**
 ...
 */
function bn12(n) {
    return bn(web3_1.default.utils.toWei(n.toString().split(",").join(""), "szabo"));
}
exports.bn12 = bn12;
/**
 ...
 */
function bn9(n) {
    return bn(web3_1.default.utils.toWei(n.toString().split(",").join(""), "gwei"));
}
exports.bn9 = bn9;
/**
 ...
 */
function bn6(n) {
    return bn(web3_1.default.utils.toWei(n.toString().split(",").join(""), "lovelace"));
}
exports.bn6 = bn6;
/**
...
function fmt18(ether) {
    return commafy(web3_1.default.utils.fromWei(bn(ether), "ether"));
}
exports.fmt18 = fmt18;
/**
...
function fmt12(ether) {
    return commafy(web3_1.default.utils.fromWei(bn(ether), "szabo"));
}
exports.fmt12 = fmt12;
/**
 ...
 */
function fmt9(ether) {
    return commafy(web3_1.default.utils.fromWei(bn(ether), "gwei"));
}
exports.fmt9 = fmt9;
/**
 ...
 */
function fmt6(ether) {
    return commafy(web3_1.default.utils.fromWei(bn(ether), "lovelace"));
}
exports.fmt6 = fmt6;
