...
export interface SushiswapMasterchefAbi extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): SushiswapMasterchefAbi;
  clone(): SushiswapMasterchefAbi;
  methods: {
    ...
    bonusEndBlock(): NonPayableTransactionObject<string>;
    ...
    sushiPerBlock(): NonPayableTransactionObject<string>;
