...
export interface AlpacaIBAlpacaAbi extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
    options?: ContractOptions
  ): AlpacaIBAlpacaAbi;
  clone(): AlpacaIBAlpacaAbi;
  methods: {
    ...
    debtShareToVal(
      debtShare: number | string | BN
    ): NonPayableTransactionObject<string>;

    debtToken(): NonPayableTransactionObject<string>;

    debtValToShare(
      debtVal: number | string | BN
    ): NonPayableTransactionObject<string>;
