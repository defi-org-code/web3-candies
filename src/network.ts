...
export const networks = {
  ...
  unichain: {
    ...
    wToken: erc20sData.unichain.WETH,
    publicRpcUrl: "wss://unichain-rpc.publicnode.com",
    logoUrl: "https://icons.llamao.fi/icons/chains/rsz_unichain?w=48&h=48",
  ...
  xlayer: {
    ...
    native: {
      ...
      symbol: "OKB",
      decimals: 18,
      logoUrl: "https://icons.llamao.fi/icons/chains/rsz_x-layer?w=48&h=48",
    },
    wToken: erc20sData.xlayer.WOKB,
