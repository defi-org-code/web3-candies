...
export interface CLIOptionalParamDefinition<T> extends OptionalParamDefinition<T> {
...
export declare type HardhatParamDefinitions = {
  [param in keyof Required<HardhatArguments>]: CLIOptionalParamDefinition<HardhatArguments[param]>;
};
